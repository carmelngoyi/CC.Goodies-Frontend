...
async function loadProducts() {
  const res = await apiFetch("/Api/cereals");
...
const Cereal = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch(`${elasticIP}/cereals`);
  ...
  if (loading) return <p>Loading Cereals...</p>;
  ...
  <div className="page-wrapper3">
    ...
    <div className="divider">
      ...
      <h1 className="divider-text text1">MORNING!</h1>
      <h1 className="divider-text text2">FUEL!</h1>
      <h1 className="divider-text text1">ENERGY!</h1>
    ...
    <h1 style={{fontFamily: "Arial, Helvetica, sans-serif",
      ...
      color: "darkblue", 
      textAlign: "center"}} 
      className="page-title">Start Your Day the Best Way!</h1>
