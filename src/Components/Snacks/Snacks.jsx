...
const Snacks = () => {
  ...
  <div className="page-wrapper7">
    ...
    <div className="divider">
      <h1 className="divider-big">GRAB</h1>
      <h1 className="divider-text text1">MUNCH!</h1>
      <h1 className="divider-text text2">CRUNCH!</h1>
      <h1 className="divider-text text1">SNACK!</h1>
      <h1 className="divider-big">THE DAY</h1>
    ...
    <h1 style={{fontFamily: "Arial, Helvetica, sans-serif",
      ...
      color: "darkblue", 
      textAlign: "center"}} 
      className="page-title">Your Ultimate Fix for Cravings and Treats!</h1>
